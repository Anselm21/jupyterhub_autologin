...
import sys
sys.path.append("./")
from myauth.myauth import MyPAM

c = get_config()
c.JupyterHub.authenticator_class = 'myauth.myauth.MyPAM'
...
# Authenticator.authenticate(c.Authenticator, handler, {'username': 'alex', 'password': '122333'})
# Authenticator.pre_spawn_start(c.Authenticator, user, c.JupyterHub.spawner_class)
